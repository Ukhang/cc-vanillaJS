document.addEventListener("DOMContentLoaded", function () {
  ...
  function gameLoop() {
    ...
    // Update speeds
    hSpeedEl.textContent = Math.abs(
      horizontalSpeed + wind * windDirection,
    ).toFixed(1);
    ...
    if (horizontalPos > window.innerWidth - 80)
      horizontalPos = window.innerWidth - 80;
  ...
  function endGame() {
    ...
    if (
      verticalSpeed > 1.5 ||
      Math.abs(horizontalSpeed + wind * windDirection) > 2
    ) {
