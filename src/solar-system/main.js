...
class RingedPlanet extends Planet {
    constructor(name, radius, distance, orbitSpeed, color, description, ringColor) {
...
class SolarSystem {
    ...
    static createDefaultSystem(containerId) {
        ...
        // Add planets
        system.addBody(new Planet('Mercury', 4, 90, 4.1, '#BBB', 
        ...
        system.addBody(new Planet('Venus', 8, 120, 1.6, '#E39E1C', 
        ...
        system.addBody(new Planet('Earth', 8.5, 150, 1, '#4B67BD', 
        ...
        system.addBody(new Planet('Mars', 6, 180, 0.5, '#C1440E', 
        ...
        system.addBody(new Planet('Jupiter', 20, 240, 0.08, '#E0A343', 
